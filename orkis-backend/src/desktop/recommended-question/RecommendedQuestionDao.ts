...
// SQLite override of src/main/recommended-question/RecommendedQuestionDao.ts
// - placeholder: $N → ? (WHERE→LIMIT 순서로 push → SQL 등장 순서와 일치)
// - boolean isActive → 1/0
// - RANDOM(): SQLite/PG 동일 동작 (변환 불필요)
